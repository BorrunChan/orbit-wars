"""
v133 — v131 + 4P concentrated-strike fix.

v131's concentrated strike (garrison>=40 -> send all) causes 4P R4 rate 35%
(vs v128's 20%). Root cause: emptied planets get captured by 3rd-party in 4P.
Kaggle data: ALL 11 v131 R4 losses had min_garrison=0 at some point.

Fix: concentrated strike only in 2P. In 4P, revert to v128's conservative
base_ships-only dispatch. Also detect num_players properly.
"""
import math
