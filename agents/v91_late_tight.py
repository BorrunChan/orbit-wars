...
def agent(obs):
    ...
    if _V_TREES is not None:
        ...
        # v91: tighten only at >0.85 (later) — V over-confident in 2P with
        # opp_alive=1/3 looking like endgame. Don't crank threshold too soon.
        if p_win > 0.85 and num_players == 2:
