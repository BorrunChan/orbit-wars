...
def agent(obs):
    ...
    if _V_TREES is not None:
        ...
        # v67: V no-tighten — only loosen when behind. Tightening when V
        # thinks we're winning may be redundant now that sim opp=none in 4P
        # already makes attacks look good.
        if p_win < 0.3:
