...
def agent(obs):
    ...
    # v47: V model DISABLED. V was trained on data where main had the 4P bug
    # (51% of main rows had 0 launches at pos 2/3). After fix, state
    # distributions changed and V may be miscalibrated. Test: agent without
    # V modulation = pure bug-fix + threshold table.
    if False:  # _V_TREES is not None:
        pass
