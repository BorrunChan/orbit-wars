...
try:
    ...
    # v57: V model was trained with base_score=0.5 but training labels were
    # ~25% positive (1 winner per 4P game). Sanity tests showed V predicts
    # ~92% for "even midgame 4P" — way overconfident. Calibrate V_BASE
    # toward log(0.25/0.75) ≈ -1.1 so predictions reflect 4P baseline.
    _V_BASE -= 1.1
except Exception:
    pass
