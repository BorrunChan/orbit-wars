...
SUN_BUFFER = 0.6
EPISODE_STEPS = 500
SIM_HORIZON = 16     # 2P horizon (4P uses _HZ_4P)
_HZ_4P = 12          # v75: shorter horizon in 4P
DEFENSE_HORIZON = 40
...
def agent(obs):
    ...
    baseline_eval = _simulate(baseline_state, [], [], SIM_HORIZON if num_players != 4 else _HZ_4P, player,
    ...
    for key in group_keys:
        ...
        for score, _mid, _tid, ships, angle, T in grouped[key]:
            ...
            new_eval = _simulate(trial_state, trial_moves, [], SIM_HORIZON if num_players != 4 else _HZ_4P,
