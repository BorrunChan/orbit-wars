...
def agent(obs):
    ...
    # v55: drop the second-pass move-drop loop. Sim is noisy on short horizons
    # and may falsely "improve" by dropping good attacks. Test: is the drop
    # pass actually helping or hurting?
