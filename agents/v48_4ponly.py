...
# v48: only relax 4P thresholds. Keep 2P at v43 values (44% baseline).
# v45 lowered both 2P+4P; 2P regressed -6pp. Isolate 4P-only relaxation.
SHOT_REJECT_THRESHOLD = 0.40   # unchanged from v43 (2P fast)
SHOT_THRESHOLD_SLOW = 0.20     # unchanged from v43 (2P slow)

SHOT_THRESHOLD_4P_SLOW = 0.25  # was 0.30 → 4P only
SHOT_THRESHOLD_4P_FAST = 0.45  # was 0.50 → 4P only
