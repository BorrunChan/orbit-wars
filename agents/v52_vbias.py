...
def agent(obs):
    ...
    if _V_TREES is not None:
        ...
        # v52: V was trained on data with overconfident "win" labels (training
        # set had many mid states labeled won). Raise tighten threshold so we
        # only tighten when V is truly confident.
        if p_win > 0.85:
