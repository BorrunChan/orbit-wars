"""
v131 — v128 + 3 data-driven upgrades for Kaggle climb.

Base: v128 (proto1000 derivative, Kaggle best at 853.3, only TrueSkill-positive
version). Changes target the 3 biggest gaps vs 900+ players identified in
对手战术库_v3.md (998-replay multi-dimensional analysis):

1. MIN_SHIPS 5->8: avg_fleet 20->closer to 900-seg 32. 5-ship fleets at
   1.5/turn are useless across map; 8-ship at 1.8 arrive with enough mass.
2. Neutral expansion bonus in custom_score: 900+ sustain expansion_momentum
   0.039 vs our 0.026. NEUTRAL_BONUS keeps the agent expanding mid/late
   instead of tunnel-visioning enemy targets.
3. Concentrated strikes: when garrison is high and no threat, send as one
   big fleet. Targets max_fleet gap (ours 140 vs 900+ 200+).
"""
import math
