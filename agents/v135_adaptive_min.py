"""
v135 — v133 + adaptive MIN_SHIPS + poor-map adaptation.

1. Adaptive MIN_SHIPS: 5 during expansion (step<60), 8 after.
   v128(MIN=5) hits 908 vs v131(MIN=8) at 874 — MIN=8 loses 30pp vs <800.
2. Poor-map scoring: on maps with total_prod<65, reduce production weight
   (15->8) and boost distance weight. 799-game analysis: 41% WR on poor
   maps vs 57% on rich — 16pp gap is the single largest map-dependent effect.
Also keeps v133's 4P concentrated-strike fix.
"""
import math
