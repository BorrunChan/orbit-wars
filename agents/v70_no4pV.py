...
def agent(obs):
    ...
    # v70: V completely off in 4P — test if V's "loosen when behind" still
    # helps now that v69 already removed tightening in 4P.
    if _V_TREES is not None and num_players == 2:
